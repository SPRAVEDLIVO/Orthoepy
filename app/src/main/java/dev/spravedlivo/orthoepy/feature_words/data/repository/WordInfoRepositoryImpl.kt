...
class WordInfoRepositoryImpl(
    ...
    override suspend fun getWordRecords(ids: List<Int>): List<WordRecord> =
        wordsDao.getWordEntities(ids).map { it.toWordRecord() }

    override suspend fun upsertWordRecord(wordRecord: WordRecord) =
        wordsDao.upsertWordEntity(wordRecord.toWordEntity())
